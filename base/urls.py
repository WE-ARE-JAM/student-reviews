...
urlpatterns = [
    ...
    path('search-results', views.student_search, name='search-results'),
    ...
    path('dashboard/student-upload', views.upload_csv, name='student-upload'),
    path('dashboard/add-student', views.student_form, name='add-student'),
